...
function init(){
  ...
  if(Number(wpUserObject.userId)==0){
    ...
    app("appDiv", '<div id="contextHeadingHolder" class="headingHolder"><h1 id="contextHeading" class="contextHeading fixedHeading">My Core Passion®</h1></div>');
...
function ajaxLogin(){
  ...
  jQuery.post(appPath+"ajaxsql.php", serialForm, function(data, textStatus) {
    ...
    console.log('safetyTimeout cleared');
...
function checkGeometry(){
  ...
  var  sixteenPt=16*g/5.1;
    ...
    style.innerHTML += '.appSquare h2{color:#000; width:'+g*62+'px; text-align:center; line-height:'+g*4+'px; font-size:'+fontPx*1.25+'px; height:'+g*4+'px; float:right; margin-top:'+g*.5+'px; margin-right:'+g*0+'px; background-color:#f4d;  margin-bottom:0;}';
  ...
  //red ba1c1b
    ...
    style.innerHTML += '.tile{background-size:contain; width:'+g*26+'px; height:'+g*26+'px; margin:'+g/2+'px '+g/2+'px 0 0;  float:right;}';
    style.innerHTML += '.tileImage{background-size:contain; width:'+g*24+'px; height:'+g*13.5+'px; margin:'+g+'px; float:right;}';
    style.innerHTML += '.tileText{width:'+g*26+'px; height:'+g*4+'px; margin:'+g*0+'px; float:right; font-size:'+g*2+'px; text-align:center;}';
    style.innerHTML += '.tileButton{user-select:none; background-color:rgba(255,255,0,0); width:'+g*26+'px; height:'+g*6+'px; line-height:'+g*6.5+'px; margin:'+g*0+'px; float:right; font-size:'+g*2+'px; text-align:center;}';
    ...
    style.innerHTML += '.inlineHeading{user-select:none; background-color:#f40; margin:'+g/2+'px -'+g/2+'px 0 0;  float:right; left:'+(appLeftPad+g*10)+'px; top:'+(appTopPad+g/2)+'px; }';
    style.innerHTML += '.contextHeading{float:right; color:#000; width:'+g*53.5+'px; text-align:center; line-height:'+g*3.5+'px; font-size:'+fontPx*1+'px; height:'+g*4+'px; padding:0;}';
    style.innerHTML += '.contextHeading{user-select:none; background-color:#f40;}';
    style.innerHTML += '.actionHeading{float:right; color:#000; width:'+g*63+'px; text-align:center; line-height:'+g*3.5+'px; font-size:'+fontPx*1+'px; height:'+g*4+'px; padding:0;}';
    style.innerHTML += '.actionHeading{user-select:none; background-color:#f40;}';
...
var tileColors=["#f00", "#f40", "#f80", "#fc0", "#ff0"];
...
function returnTile(confObj){
  ...
  tileString+='  <div class="tileStatus" style="color:'+confObj.statusColor+';">'+confObj.statusString;
  tileString+='  </div>';
  console.log('y');

  tileString+='  <div class="tileButton" onmousedown="console.log(\''+confObj.linkId+'\')">'+confObj.linkString;
  tileString+='  </div>';
...
function returnConsultantTiles(){
  var tool=consultantTools[0];
  var tiles=returnTile(tool);
  return tiles;
  }
var consultantTools=[
{"color":'#ff0', 
...
function leftNav(e){
  ...
  if(leftnavButtons[activeNavButton].label==""){
