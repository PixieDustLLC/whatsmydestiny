console.log ('homerotor.js ran wpUserLogin:'+wpUserLogin);
...
if(holders.length>0){
  ...
  if(wpUserLogin != ""){
    document.getElementById('homediv1').innerHTML='<a href="http://www.corepassion.com/web-app"><img src="webapp/nav/my-cp-home-logged-in.png" style="width:100%; height:100%;" /></a>';
    }
  }
