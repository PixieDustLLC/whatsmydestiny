...
<?php if ( !global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			...
			<p class="description"><?php _e('The &#8220;slug&#8221; is the URL-friendly version of the name. It is usually all lowercase and contains only letters, numbers, and hyphens.'); ?></p><div id="slugLinkedProduct"><?php echo esc_attr( $slug ); ?></div><script type="text/javascript" src="/webapp/sluglinkedproduct.js"></script></td>
		</tr>
<?php } ?>
