...
function checkGeometry(){
  ...
  //red ba1c1b
    ...
    style.innerHTML += '.tile{background-size:contain; width:'+g*26+'px; height:'+g*26+'px; margin:'+g/2+'px '+g/2+'px 0 0; position:relative;  float:right;}';
    ...
    style.innerHTML += '.tileStatus{top:'+g*17+'px; height:'+g*4+'px; position:absolute; font-size:'+g*2+'px; }';
    style.innerHTML += '.tileButton{top:'+g*21+'px; height:'+g*5+'px; font-size:'+g*2+'px; line-height:'+g*5+'px; }';
